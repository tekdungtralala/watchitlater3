...
public class AuthModel {
	...
	public void checkAuthModel() throws AuthExpiredException {
		...
		// throw new AuthExpiredException("Auth is expired, less than " + ACTIVE_HOUR +
		// " hour");
//		if (ACTIVE_MINUTE <= minutes)
//			throw new AuthExpiredException("Auth is expired, less than " + ACTIVE_MINUTE + " minute");
		if (ACTIVE_SECOND <= secs)
			throw new AuthExpiredException("Auth is expired, less than " + ACTIVE_SECOND + " second");
	}
}
